...
// What the plate reads, or null when the card shows no plate. A spell's tribe is
// its school ("Frost Spell"); weapons/locations carry no tribe so the plate names
// the card type ("Hero Weapon" / "Location"); an Equipment (an artifact with an
// `equip` payload) shows an MTG-style "Artifact - Equipment" type line; a passive
