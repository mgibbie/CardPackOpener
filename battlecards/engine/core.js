...
import { getEffectHandler } from './effects/registry.js';
...
export function runSecretEffects(state, pi, effects, ctx) {
	...
	for (const e of effects || []) {
		switch (e.type) {
			...
			case 'silence-destroy-triggering': {
...
export function execEffects(state, pi, effects, target, source) {
	...
	for (const e of effects || []) {
		...
		} else if (e.type === 'cenarius-thrice') {
		...
		} else if (e.type === 'informant-discover') {
		...
		} else if (e.type === 'geddon-draws') {
			state.players[pi].geddonDraw = true; // Commander Geddon
		} else if (e.type === 'leviathan-siphon') {
		...
		} else if (e.type === 'destroy-adjacent-random') {
		...
		} else if (e.type === 'underbelly-stock') {
		...
		} else if (e.type === 'underbelly-discover') {
			const p = state.players[pi];
		...
		} else if (e.type === 'corpse-double') {
			state.players[pi].corpseDouble = true; // Falric
		} else if (e.type === 'corpse-bride') {
		...
		} else if (e.type === 'reduce-hand-tribe-cost') {
		...
		} else if (e.type === 'doommaiden-draw') {
		...
		} else if (e.type === 'galaxy-lens') {
			state.players[pi].galaxyLens = true; // Farseer Nobundo
		} else if (e.type === 'illusion-copy') {
		...
		} else if (e.type === 'transform-deck-neutrals') {
		...
		} else if (e.type === 'alarashi-demons') {
		...
		} else if (e.type === 'forefather-guess') {
		...
		} else if (e.type === 'awaken-imprisoned') {
		...
		} else if (e.type === 'skip-own-next-turn') {
		...
		} else if (e.type === 'own-deck-top-pick') {
		...
		} else if (e.type === 'destroy-random-secret') {
		...
		} else if (e.type === 'voidwalker-envy') {
		...
		} else if (e.type === 'crewmate-adjoin') {
		...
		} else if (e.type === 'ancient-regurgitate') {
			const p = state.players[pi];
		...
		} else if (e.type === 'draw-discount-turn') {
		...
		} else if (e.type === 'eyes-in-the-sky') {
		...
		} else if (e.type === 'hero-attack-multi-turn') {
		...
		} else if (e.type === 'heal-lock-enemy') {
		...
		} else if (e.type === 'infinity-restore') {
			const p = state.players[pi];
		...
		} else if (e.type === 'damage-excess-draw') {
		...
		} else if (e.type === 'reset-hand-costs') {
		...
		} else if (e.type === 'heal-by-self-health') {
		...
		} else if (e.type === 'buff-distinct-tribes') {
		...
		} else if (e.type === 'sylvanas-volley') {
		...
		} else if (e.type === 'recruit-attack-boost') {
		...
		} else if (e.type === 'attack-random-enemies') {
		...
		} else if (e.type === 'spend-mana-double-stats') {
		...
		} else if (e.type === 'corpse-next-card') {
			state.players[pi].nextCardCorpses = true; // Exarch Maladaar
		} else if (e.type === 'spend-corpses-stats') {
		...
		} else if (e.type === 'discard-remembered') {
			const p = state.players[pi];
		...
		} else if (e.type === 'replay-last-turn') {
		...
		} else if (e.type === 'hand-match-shuffle') {
		...
		} else if (e.type === 'foreign-demon-discount') {
			const p = state.players[pi];
			p.foreignDemonDiscount = (p.foreignDemonDiscount || 0) + (e.value || 1); // Foreboding Flame
		} else if (e.type === 'summon-played-foreign-demons') {
		...
		} else if (e.type === 'discount-adjacent') {
		...
		} else if (e.type === 'bwonsamdi-summon') {
		...
		} else if (e.type === 'hammer-grow-return') {
		...
		} else if (e.type === 'transform-all-except-name') {
		...
		} else if (e.type === 'buff-next-drawn-minions') {
