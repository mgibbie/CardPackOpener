...
import { spendCorpses, venture } from '../../engine.js';

// Advance / "Venture into the Dungeon": enter a dungeon or advance to the next room.
register('venture', ({ state, pi }) => { venture(state, pi); });
