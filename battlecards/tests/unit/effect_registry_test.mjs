...
// --- registry contract ---
{
	ok('pilot + batch types registered (1008 after zuramat)', registeredTypes().length === 1008 && !!getEffectHandler('armor') && !!getEffectHandler('zuramat-prison-tap') && !!getEffectHandler('play-prison-discarded'));
