...
// --- registry contract ---
{
	ok('pilot + batch types registered (1088 after fidelity grand-finale handler)', registeredTypes().length === 1088 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
