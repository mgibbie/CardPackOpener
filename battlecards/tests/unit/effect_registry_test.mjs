...
// --- registry contract ---
{
	ok('pilot + batch types registered (971 after the merge-if-two / transform-lowest-hand-spell handlers)', registeredTypes().length === 971 && !!getEffectHandler('armor') && !!getEffectHandler('merge-if-two'));
