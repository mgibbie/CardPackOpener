...
// --- registry contract ---
{
	ok('pilot + batch types registered (989 after set-next-summon-stats + summon-scaled-cards-played)', registeredTypes().length === 989 && !!getEffectHandler('armor') && !!getEffectHandler('set-next-summon-stats'));
