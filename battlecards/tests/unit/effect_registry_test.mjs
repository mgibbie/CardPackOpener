...
// --- registry contract ---
{
	ok('pilot + batch types registered (1096 after fidelity set-holy-refresh-shield)', registeredTypes().length === 1096 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
