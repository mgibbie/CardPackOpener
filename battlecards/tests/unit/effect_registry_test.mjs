...
// --- registry contract ---
{
	ok('pilot + batch types registered (1017 after bucket-spell handler extensions)', registeredTypes().length === 1017 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
