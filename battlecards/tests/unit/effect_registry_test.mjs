...
// --- registry contract ---
{
	ok('pilot + batch types registered (1013 after draw-minion-tribe-then + grant-next-deathrattle-discount)', registeredTypes().length === 1013 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
