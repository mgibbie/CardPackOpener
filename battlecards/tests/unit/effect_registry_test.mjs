...
// --- registry contract ---
{
	ok('pilot + batch types registered (1011 after spend-all-mana-damage)', registeredTypes().length === 1011 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
