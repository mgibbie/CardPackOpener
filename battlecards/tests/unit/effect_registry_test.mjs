...
// --- registry contract ---
{
	ok('pilot + batch types registered (1111 incl. advance + assemble + grant-target + target-player)', registeredTypes().length === 1111 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage') && !!getEffectHandler('advance') && !!getEffectHandler('assemble') && !!getEffectHandler('grant-target') && !!getEffectHandler('target-player'));
