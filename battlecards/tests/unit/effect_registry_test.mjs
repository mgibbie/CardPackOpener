...
// --- registry contract ---
{
	ok('pilot + batch types registered (1090 after fidelity summon-attack-random)', registeredTypes().length === 1090 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
