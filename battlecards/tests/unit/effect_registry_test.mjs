...
// --- registry contract ---
{
	ok('pilot + batch types registered (1093 after fidelity delayed mind-control)', registeredTypes().length === 1093 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
