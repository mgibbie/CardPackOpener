...
// --- registry contract ---
{
	ok('pilot + batch types registered (1048 after the spend-X resources family)', registeredTypes().length === 1048 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
