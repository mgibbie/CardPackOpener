...
// --- registry contract ---
{
	ok('pilot + batch types registered (1043 after spell-import handler waves)', registeredTypes().length === 1043 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
