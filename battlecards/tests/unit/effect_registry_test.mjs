...
// --- registry contract ---
{
	ok('pilot + batch types registered (1107 after fidelity look-enemy-hand-shuffle)', registeredTypes().length === 1107 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
