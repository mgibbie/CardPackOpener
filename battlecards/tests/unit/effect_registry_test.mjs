...
// --- registry contract ---
{
	ok('pilot + batch types registered (1072 after the quick one-offs batch)', registeredTypes().length === 1072 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
