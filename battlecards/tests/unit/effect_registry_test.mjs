...
// --- registry contract ---
{
	ok('pilot + batch types registered (963 after the resurrect-tribe handler)', registeredTypes().length === 963 && !!getEffectHandler('armor') && !!getEffectHandler('resurrect-tribe'));
