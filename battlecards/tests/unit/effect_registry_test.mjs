...
// --- registry contract ---
{
	ok('pilot + batch types registered (1037 after bucket-spell handler extensions)', registeredTypes().length === 1037 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
