...
// --- registry contract ---
{
	ok('pilot + batch types registered (956 after the Duels dragonbone-revive handler)', registeredTypes().length === 956 && !!getEffectHandler('armor') && !!getEffectHandler('investigate'));
