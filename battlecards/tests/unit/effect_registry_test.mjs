...
// --- registry contract ---
{
	ok('pilot + batch types registered (1102 after fidelity smoldering trio)', registeredTypes().length === 1102 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
