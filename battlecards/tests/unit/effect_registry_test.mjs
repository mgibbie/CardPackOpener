...
// --- registry contract ---
{
	ok('pilot + batch types registered (1009 after next-relic-double-cast)', registeredTypes().length === 1009 && !!getEffectHandler('armor') && !!getEffectHandler('next-relic-double-cast'));
