...
// --- registry contract ---
{
	ok('pilot + batch types registered (1003 after tiny-pal)', registeredTypes().length === 1003 && !!getEffectHandler('armor') && !!getEffectHandler('tiny-pal-attack') && !!getEffectHandler('set-tiny-pal-ammo'));
