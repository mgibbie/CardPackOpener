...
// --- registry contract ---
{
	ok('pilot + batch types registered (1085 after fidelity spend-location-durability-heal)', registeredTypes().length === 1085 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
