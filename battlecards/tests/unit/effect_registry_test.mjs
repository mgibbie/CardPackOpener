...
// --- registry contract ---
{
	ok('pilot + batch types registered (993 after set-weapon-attack-temp)', registeredTypes().length === 993 && !!getEffectHandler('armor') && !!getEffectHandler('set-weapon-attack-temp'));
