...
// --- registry contract ---
{
	ok('pilot + batch types registered (1061 after the next-spell modifiers family)', registeredTypes().length === 1061 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
