...
// --- registry contract ---
{
	ok('pilot + batch types registered (965 after the put-spell-on-enemy-deck-top / steal-stats-all-enemies handlers)', registeredTypes().length === 965 && !!getEffectHandler('armor') && !!getEffectHandler('steal-stats-all-enemies'));
