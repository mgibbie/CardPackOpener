...
// --- registry contract ---
{
	ok('pilot + batch types registered (1034 after bucket-spell handler extensions)', registeredTypes().length === 1034 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
