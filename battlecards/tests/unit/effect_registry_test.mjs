...
// --- registry contract ---
{
	ok('pilot + batch types registered (1089 after fidelity buff-shared-type)', registeredTypes().length === 1089 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
