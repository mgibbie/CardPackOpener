...
// --- registry contract ---
{
	ok('pilot + batch types registered (958 after the enemy-cards-cost-more handler)', registeredTypes().length === 958 && !!getEffectHandler('armor') && !!getEffectHandler('enemy-cards-cost-more'));
