...
// --- registry contract ---
{
	ok('pilot + batch types registered (966 after the lose-random-stat handler)', registeredTypes().length === 966 && !!getEffectHandler('armor') && !!getEffectHandler('lose-random-stat'));
