...
// --- registry contract ---
{
	ok('pilot + batch types registered (1106 after fidelity remix rotating bonus)', registeredTypes().length === 1106 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
