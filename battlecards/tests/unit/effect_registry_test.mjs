...
// --- registry contract ---
{
	ok('pilot + batch types registered (1099 after fidelity unidentified-shield)', registeredTypes().length === 1099 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
