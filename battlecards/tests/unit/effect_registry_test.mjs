...
// --- registry contract ---
{
	ok('pilot + batch types registered (973 after the steal-entered-hand / swap-self-with-enemy-hand handlers)', registeredTypes().length === 973 && !!getEffectHandler('armor') && !!getEffectHandler('steal-entered-hand'));
