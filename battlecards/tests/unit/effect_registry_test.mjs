...
// --- registry contract ---
{
	ok('pilot + batch types registered (1091 after fidelity draw-minions-swap-health)', registeredTypes().length === 1091 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
