...
// --- registry contract ---
{
	ok('pilot + batch types registered (1103 after fidelity imp-losion)', registeredTypes().length === 1103 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
