...
// --- registry contract ---
{
	ok('pilot + batch types registered (1084 after fidelity destroy-zero-attack-enemies)', registeredTypes().length === 1084 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
