...
// --- registry contract ---
{
	ok('pilot + batch types registered (1109 incl. advance + assemble)', registeredTypes().length === 1109 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage') && !!getEffectHandler('advance') && !!getEffectHandler('assemble'));
