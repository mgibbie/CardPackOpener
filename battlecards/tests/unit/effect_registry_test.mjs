...
// --- registry contract ---
{
	ok('pilot + batch types registered (1053 after the time-bombs family)', registeredTypes().length === 1053 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
