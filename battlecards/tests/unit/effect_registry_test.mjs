...
// --- registry contract ---
{
	ok('pilot + batch types registered (957 after the return-from-graveyard handler)', registeredTypes().length === 957 && !!getEffectHandler('armor') && !!getEffectHandler('return-from-graveyard'));
