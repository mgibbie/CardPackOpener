...
// --- registry contract ---
{
	ok('pilot + batch types registered (1112 incl. advance + assemble + grant/target/buff picks)', registeredTypes().length === 1112 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage') && !!getEffectHandler('advance') && !!getEffectHandler('assemble') && !!getEffectHandler('grant-target') && !!getEffectHandler('target-player') && !!getEffectHandler('buff-target'));
