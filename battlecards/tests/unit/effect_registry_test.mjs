...
// --- registry contract ---
{
	ok('pilot + batch types registered (962 after the fill-board-token handler)', registeredTypes().length === 962 && !!getEffectHandler('armor') && !!getEffectHandler('fill-board-token'));
