...
// --- registry contract ---
{
	ok('pilot + batch types registered (1108 incl. advance)', registeredTypes().length === 1108 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage') && !!getEffectHandler('advance'));
