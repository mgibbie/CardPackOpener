...
// --- registry contract ---
{
	ok('pilot + batch types registered (1087 after fidelity overflow handlers)', registeredTypes().length === 1087 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
