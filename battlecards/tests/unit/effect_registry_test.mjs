...
// --- registry contract ---
{
	ok('pilot + batch types registered (1098 after fidelity shadeleaf + horn outcast)', registeredTypes().length === 1098 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
