...
// --- registry contract ---
{
	ok('pilot + batch types registered (996 after buff-equipped-weapon)', registeredTypes().length === 996 && !!getEffectHandler('armor') && !!getEffectHandler('buff-equipped-weapon'));
