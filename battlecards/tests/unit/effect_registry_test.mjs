...
// --- registry contract ---
{
	ok('pilot + batch types registered (975 after the refresh-self-attack / refresh-hero-attack handlers)', registeredTypes().length === 975 && !!getEffectHandler('armor') && !!getEffectHandler('refresh-self-attack'));
