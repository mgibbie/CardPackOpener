...
// --- registry contract ---
{
	ok('pilot + batch types registered (1110 incl. advance + assemble + grant-target)', registeredTypes().length === 1110 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage') && !!getEffectHandler('advance') && !!getEffectHandler('assemble') && !!getEffectHandler('grant-target'));
