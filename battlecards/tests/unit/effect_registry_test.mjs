...
// --- registry contract ---
{
	ok('pilot + batch types registered (1095 after fidelity soul-rend + hounds)', registeredTypes().length === 1095 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
