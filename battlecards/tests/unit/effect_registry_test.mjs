...
// --- registry contract ---
{
	ok('pilot + batch types registered (1083 after the final seven — HS spells 100%)', registeredTypes().length === 1083 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
