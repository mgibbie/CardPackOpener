...
// --- registry contract ---
{
	ok('pilot + batch types registered (1057 after the deck-rewrites family)', registeredTypes().length === 1057 && !!getEffectHandler('armor') && !!getEffectHandler('spend-all-mana-damage'));
