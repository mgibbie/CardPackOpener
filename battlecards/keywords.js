...
const K = [
	...
	{ p: ['Frigid'], t: 'Freeze any character that survives combat with it — creature, planeswalker, or player.', tag: 'frigid' },
	...
	{ p: ['Tempt', 'The Ring tempts you', 'the Ring tempts you'], t: 'Tempt: level up your Ring (once each) and choose a creature you control as your Ring-bearer. L1 it gains Stealth; L2 it loots (draw, then discard) when it attacks; L3 it gains Deathtouch and +1/+1; L4 whenever it damages a hero, each opponent loses 3.' },
	...
	{ p: ['Overkill'], t: 'When this deals more than enough damage to kill a creature on your turn, the excess triggers a bonus effect.' },
	{ p: ['Dormant'], t: 'Enters asleep: it can’t attack or be targeted, and awakens (firing its effect) after a set number of your turns.' },
	{ p: ['Silence'], t: 'Remove a creature’s card text, keywords, enchantments, and effects, leaving a plain creature.' },
	...
	{ p: ['Bounce'], t: "Return a creature to its owner's hand." },
