...
export const BOSSES = {
	waste_wanderer_cardish: { name: 'Waste Wanderer Cardish', health: 20, hsId: 'ULDA_BOSS_01h', power: { name: 'Boom Bullets', cost: 2, text: 'Create a 0/2 Goblin Bomb with Taunt.', effects: [{ type: 'summon', count: 1, attack: 0, health: 2, name: 'Goblin Bomb', tribe: 'Mech', keywords: ['taunt'] }] }, theme: { tribe: 'Mech' } },
	...
	nash_the_greatworm: { name: 'Nash the Greatworm', health: 20, hsId: 'ULDA_BOSS_04h', power: { name: 'Belch', cost: 3, text: 'Create a creature that died this game.', effects: [{ type: 'resurrect-highest-died', count: 1 }] }, theme: { tribe: 'Beast' } },
	...
	pyramad: { name: 'Pyramad', health: 20, hsId: 'ULDA_BOSS_12h', power: { name: 'Brick by Brick', cost: 3, text: 'Create a random Elemental that costs (3).', effects: [{ type: 'summon-random', tribe: 'Elemental', cost: 3 }] }, theme: { tribe: 'Elemental' } },
	snakeflinger_scalesnout: { name: 'Snakeflinger Scalesnout', health: 20, hsId: 'ULDA_BOSS_13h', power: { name: 'Snakeshot', cost: 2, text: 'Create a 1/1 Snake with Poisonous.', effects: [{ type: 'summon', count: 1, attack: 1, health: 1, name: 'Snake', tribe: 'Beast', keywords: ['poisonous'] }] }, theme: { tribe: 'Beast' } },
	...
	ichabod_the_cursed: { name: 'Ichabod the Cursed', health: 20, hsId: 'ULDA_BOSS_17h', power: { name: 'Spreading the Curse', cost: 2, text: 'Create a 1/1 Leper Gnome with Rush.', effects: [{ type: 'summon', count: 1, attack: 1, health: 1, name: 'Leper Gnome', keywords: ['rush', 'deathrattle'], deathrattle: [{ type: 'damage', value: 2, target: 'enemy-hero' }] }] }, theme: { cardClass: 'warlock' } },
	...
	sothis: { name: 'Sothis', health: 20, hsId: 'ULDA_BOSS_19h', power: { name: 'Titan Ritual', cost: 2, text: 'Create two 1/1 Mogu Cultists.', effects: [{ type: 'summon', count: 2, attack: 1, health: 1, name: 'Mogu Cultist' }] }, theme: { cardClass: 'neutral' } },
	...
	skarik: { name: 'Skarik', health: 20, hsId: 'ULDA_BOSS_23h', power: { name: 'Hatching Time', cost: 2, text: 'Create a random Beast that costs (2).', effects: [{ type: 'summon-random', tribe: 'Beast', cost: 2 }] }, theme: { tribe: 'Beast' } },
	suspicious_palm_tree: { name: 'Suspicious Palm Tree', health: 20, hsId: 'ULDA_BOSS_24h', power: { name: 'Corrupted Oasis', cost: 2, text: 'Create two 2/2 Treants.', effects: [{ type: 'summon', count: 2, attack: 2, health: 2, name: 'Treant' }] }, theme: { cardClass: 'druid' } },
	beetle_herder_zenda: { name: 'Beetle Herder Zenda', health: 20, hsId: 'ULDA_BOSS_25h', power: { name: 'Beetle Stampede', cost: 2, text: 'Create a 3/3 Plated Beetle with Taunt.', effects: [{ type: 'summon', count: 1, attack: 3, health: 3, name: 'Plated Beetle', tribe: 'Beast', keywords: ['taunt'] }] }, theme: { tribe: 'Beast' } },
	...
	sazin: { name: 'Sazin the Timesplitter', health: 20, hsId: 'ULDA_BOSS_28h', power: { name: 'Mighty Windstorm', cost: 2, text: 'Create a random creature that costs (3).', effects: [{ type: 'summon-random', cost: 3 }] }, theme: { cardClass: 'mage' } },
	...
	edra: { name: 'Edra', health: 20, hsId: 'ULDA_BOSS_32h', power: { name: 'Whispering Sentinels', cost: 1, text: 'Create a 1/1 Wisp with Lifesteal.', effects: [{ type: 'summon', count: 1, attack: 1, health: 1, name: 'Wisp', keywords: ['lifesteal'] }] }, theme: { cardClass: 'priest' } },
	// ---- the four Plague Lords (chapter finals) ----
	vesh: { name: 'Vesh, Plague Lord of Murlocs', health: 60, hsId: 'ULDA_BOSS_39h', power: { name: 'Plague of Murlocs', cost: 2, text: 'Create three 1/1 Murlocs.', effects: [{ type: 'summon', count: 3, attack: 1, health: 1, name: 'Murloc', tribe: 'Murloc' }] }, theme: { tribe: 'Murloc' }, plagueLord: true },
