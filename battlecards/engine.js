...
export function endTurn(state) {
	...
	// Keeper of Flame: doomed cards perish when their timer runs out
	{
		...
		if (doomedHand.length) {
			...
			for (const c of doomedHand) { toGraveyard(state, pi, c); emit(state, { type: 'discard', player: pi, card: c }); }
		}
