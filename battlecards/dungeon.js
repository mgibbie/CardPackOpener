...
export const STARTER_DECKS = {
	...
	shaman: ["earth_elemental", "stormcrack", "flametongue_totem", "murloc_tidehunter", "stormforged_axe", "lightning_storm", "unbound_elemental", "defender_of_argus", "hex", "fire_elemental"],
...
export const BOSSES = {
	...
	wee_whelp: {
		...
		deck: ["dragon_s_breath", "dragon_egg", "stonetusk_boar", "bloodfen_raptor", "faerie_dragon", "raid_leader", "chillwind_yeti", "twilight_drake", "bone_drake", "volcanic_drake"],
	},
	frostfur: {
	...
	elder_brandlemar: {
		...
		power: {"name": "Dampen Magic", "cost": 2, "text": "Put a Counterspell into the battlefield.", "effects": [{"type": "install-secret", "id": "castblock"}]},
...
export const BUCKETS = {
	druid: [
		{ name: "Balance", cards: ["moonfire", "bloodmage_thalnos", "wrath", "swipe", "bone_drake", "starfire", "malygos"] },
		...
		{ name: "Restoration", cards: ["mistress_of_mixtures", "wrath", "earthen_ring_farseer", "healing_touch", "mulch", "refreshment_vendor", "antique_healbot", "moonglade_portal"] },
	...
	hunter: [
		...
		{ name: "Defense", cards: ["snake_trap", "doomsayer", "explosive_trap", "freezing_trap", "unleash_the_hounds", "defender_of_argus", "antique_healbot", "sludge_belcher", "cloaked_huntress", "eaglehorn_bow"] },
		{ name: "Legendary", cards: ["barnes", "leeroy_jenkins", "maexxna", "king_krush", "snipe", "explosive_shot"] },
		{ name: "Secrets", cards: ["candleshot", "secretkeeper", "pack_tactics", "explosive_trap", "freezing_trap", "misdirection", "snake_trap", "multi_shot", "cobra_shot"] },
	...
	mage: [
		...
		{ name: "Lost Secrets", cards: ["mana_bind", "ice_block", "mirror_entity", "ethereal_arcanist", "archmage_antonidas", "malygos"] },
		{ name: "Magical Friends", cards: ["bloodmage_thalnos", "mana_wyrm", "sorcerer_s_apprentice", "flamewaker", "violet_teacher", "bone_drake", "gadgetzan_auctioneer"] },
	...
	paladin: [
		...
		{ name: "Dragonmaster", cards: ["netherspite_historian", "hungry_dragon", "twilight_drake", "bone_drake", "blackwing_corruptor", "dragon_consort", "volcanic_drake", "primordial_drake", "malygos"] },
	...
	priest: [
		...
		{ name: "Dragon Priest", cards: ["netherspite_historian", "wyrmrest_agent", "duskbreaker", "twilight_drake", "twilight_guardian", "hungry_dragon", "blackwing_corruptor", "bone_drake", "malygos"] },
	...
	rogue: [
		...
		{ name: "Greed", cards: ["counterfeit_coin", "bloodmage_thalnos", "cutpurse", "loot_hoarder", "coldlight_oracle", "tomb_pillager", "bone_drake", "burgly_bully"] },
	...
	shaman: [
		{ name: "Battlecrier", cards: ["brann_bronzebeard", "stonehill_defender", "saronite_chain_gang", "bone_drake", "doppelgangster", "fire_elemental", "bonemare"] },
		{ name: "Destruction", cards: ["frost_shock", "crushing_hand", "maelstrom_portal", "stormcrack", "lava_burst", "lightning_storm"] },
	...
	warrior: [
		...
		{ name: "Dragon Heart", cards: ["alexstrasza_s_champion", "netherspite_historian", "hungry_dragon", "twilight_drake", "twilight_guardian", "bone_drake", "blackwing_corruptor", "chillmaw", "primordial_drake"] },
