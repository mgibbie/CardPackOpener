...
export const BOSSES = {
	...
	jepetto_joybuzz: { name: 'Jepetto Joybuzz', health: 30, hsId: 'DALA_BOSS_25h', power: { name: 'Assembly', cost: 2, text: 'Summon a 1/1 copy of a random creature in your hand.', effects: [{ type: 'summon-hand-copy', attack: 1, health: 1 }] }, theme: { cardClass: 'neutral' } },
	...
	rasil_fireborne: { name: 'Rasil Fireborne', health: 30, hsId: 'DALA_BOSS_27h', power: { name: 'Masterpiece!', cost: 3, text: 'Summon a random creature that costs (5).', effects: [{ type: 'summon-random', cost: 5 }] }, theme: { tribe: 'Elemental' } },
	...
	lilayell_suntear: { name: 'Lilayell Suntear', health: 30, hsId: 'DALA_BOSS_68h', power: { name: 'Mini Portal', cost: 1, text: 'Summon a random 1-Cost creature.', effects: [{ type: 'summon-random', cost: 1 }] }, theme: { cardClass: 'mage' } },
	...
	kara_stamper: { name: 'Kara Stamper', health: 30, hsId: 'DALA_BOSS_74h', power: { name: 'Soul Weave', cost: 3, text: 'Discard a card. Summon a random creature that costs (3).', effects: [{ type: 'discard-random', count: 1 }, { type: 'summon-random', cost: 3 }] }, theme: { cardClass: 'warlock' } },
...
export const ANOMALIES = {
	...
	infused: { name: 'Infused', text: 'Summoned creatures gain Taunt, Divine Shield, Rush, or Windfury at random.' },
	explosive: { name: 'Explosive', text: 'Summoned creatures gain "Deathrattle: Deal 1 damage to all creatures."' },
	nesting: { name: 'Nesting', text: 'Summoned creatures gain "Deathrattle: Summon a 1/1 copy of this creature."' },
};
